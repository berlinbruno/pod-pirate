export default function manifest() {
  return {
    ...
    description:
      "Pod Pirate is your ultimate destination for discovering, streaming, and managing your favorite podcasts. Set sail on an audio adventure with our intuitive platform, where you can explore a vast ocean of content, from the latest episodes to timeless classics.",
    start_url: "/",
    display: "standalone",
    ...
    screenshots: [
      {
        ...
        sizes: "1920x1080",
        type: "image/png",
        label: "Desktop - Wide Form Factor",
        form_factor: "wide",
      },
      {
