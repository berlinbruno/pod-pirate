export default function manifest() {
  return {
    ...
    screenshot: [
      {
        src: "/screenshot/Screenshot_412x915_1.webp",
        sizes: "412x915",
        type: "image/webp",
        form_factor: "narrow",
      },
      {
        src: "/screenshot/Screenshot_412x915_2.webp",
        sizes: "412x915",
        type: "image/webp",
        form_factor: "narrow",
      },
      {
        src: "/screenshot/Screenshot_412x915_3.webp",
        sizes: "412x915",
        type: "image/webp",
        form_factor: "narrow",
      },
      {
        src: "/screenshot/Screenshot_1024x1366_1.webp",
        sizes: "1024x1366",
        type: "image/webp",
        form_factor: "wide",
      },
      {
        src: "/screenshot/Screenshot_1024x1366_2.webp",
        sizes: "1024x1366",
        type: "image/webp",
        form_factor: "wide",
      },
      {
        src: "/screenshot/Screenshot_1024x1366_3.webp",
        sizes: "1024x1366",
        type: "image/webp",
        form_factor: "wide",
      },
